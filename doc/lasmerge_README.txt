****************************************************************
  ...
  them into a single file. The filenames can either be provided
  one by one or in form of a text file.
  ...
  box. The user can also set those in the command line with
